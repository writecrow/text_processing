...
#
# Usage example:
#    python process_metadata_one_semester_correct_version.py --directory=metadata_files --master_student_file=master_fall_2021_processed.xlsx --instructor_codes_file=Instructor_Codes.xlsx
...
def combine_tabs(filename):
    if '.xlsx' in filename or '.xls' in filename:
        ...
        for i in range(1,len(tabs)):
            ...
            this_tab = pandas.merge(this_tab, mastertab, on='Registrar ID', how='left')
            #print(this_tab)
            #print(this_tab.columns)
...
def process_new_data(output_frames, master_student_data, all_master, instructor_codes, output_filename):
    ...
    if len(output_frames) > 0:
        ...
        #print (last_section_code)
        #print (last_student_code)

...
#    python convert_to_utf8_normalize_portuguese.py --directory=Processed/
#    python convert_to_utf8_normalize_portuguese.py --directory=../../../MACAWS/Portuguese/Spring_2017/Processed/
